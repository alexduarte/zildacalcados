<?php /* Smarty version Smarty-3.1.14, created on 2014-06-24 09:35:55
         compiled from "C:\wamp\www\zildacalcados\pdf\invoice.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1470653a599b0ba7286-48110265%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a5ef9b3006001b9db492deceb6aec21bb15f2d4d' => 
    array (
      0 => 'C:\\wamp\\www\\zildacalcados\\pdf\\invoice.tpl',
      1 => 1403616951,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1470653a599b0ba7286-48110265',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_53a599b105d6e6_05975887',
  'variables' => 
  array (
    'invoice_address' => 0,
    'delivery_address' => 0,
...
<?php if ($_valid && !is_callable('content_53a599b105d6e6_05975887')) {function content_53a599b105d6e6_05975887($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:\\wamp\\www\\zildacalcados\\tools\\smarty\\plugins\\modifier.date_format.php';
...
<?php  $_smarty_tpl->tpl_vars['shipping'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['shipping']->_loop = false;
 ...
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['shippingsLoop']['iteration']=0;
foreach ($_from as $_smarty_tpl->tpl_vars['shipping']->key => $_smarty_tpl->tpl_vars['shipping']->value){
$_smarty_tpl->tpl_vars['shipping']->_loop = true;
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['shippingsLoop']['iteration']++;
?>
	<table style="width: 100%; text-align: center; border: 1px solid #CCC; font-size: 9pt;">
		<tr>
			<td colspan = "3" style="background-color: #CCC; color: #000;">
				<b><?php echo smartyTranslate(array('s'=>'Delivery','pdf'=>'true'),$_smarty_tpl);?>
#<?php echo $_smarty_tpl->getVariable('smarty')->value['foreach']['shippingsLoop']['iteration'];?>
</b>
			</td>
		</tr>
		<tr>
			<td style="width: 33%; background-color: #EEE; color: #000;">
				<b><?php echo smartyTranslate(array('s'=>'Peso:','pdf'=>'true'),$_smarty_tpl);?>
</b>
			</td>
			<td style="width: 33%; background-color: #EEE; color: #000;">
			...
			<td style="width: 34%; background-color: #EEE; color: #000;">
				<b><?php echo smartyTranslate(array('s'=>'Cod. Rastreamento:','pdf'=>'true'),$_smarty_tpl);?>
</b>
			</td>
		</tr>
		<tr>
			<td style="width: 33%;">
				<?php echo sprintf("%.3f",$_smarty_tpl->tpl_vars['shipping']->value['weight']);?>
 Kg
			</td>
			<td style="width: 33%;">
				<?php echo $_smarty_tpl->tpl_vars['shipping']->value['state_name'];?>

			</td>
			<td style="width: 34%;">
				<?php echo $_smarty_tpl->tpl_vars['shipping']->value['tracking_number'];?>
...
<table style="width: 100%; font-size: 8pt;">
	<tr style="line-height:4px;">
		<td style="text-align: left; background-color: #CCC; color: #000; padding-left: 10px; font-weight: bold; width: 12%"><?php echo smartyTranslate(array('s'=>'Id','pdf'=>'true'),$_smarty_tpl);?>
</td>
		<td style="text-align: left; background-color: #CCC; color: #000; padding-left: 10px; font-weight: bold; width: 41%"><?php echo smartyTranslate(array('s'=>'Product','pdf'=>'true'),$_smarty_tpl);?>
</td>
		<!-- unit price tax excluded is mandatory -->
		<?php if (!$_smarty_tpl->tpl_vars['tax_excluded_display']->value){?>
			<td style="background-color: #CCC; color: #000; text-align: right; font-weight: bold; width: 10%"><?php echo smartyTranslate(array('s'=>'Unit Price','pdf'=>'true'),$_smarty_tpl);?>
 <br /><?php echo smartyTranslate(array('s'=>'(Tax Excl.)','pdf'=>'true'),$_smarty_tpl);?>
		...
		<td style="background-color: #CCC; color: #000; text-align: right; font-weight: bold; width: 9%"><?php echo smartyTranslate(array('s'=>'Discount','pdf'=>'true'),$_smarty_tpl);?>
</td>
		<td style="background-color: #CCC; color: #000; text-align: center; font-weight: bold; width: 5%"><?php echo smartyTranslate(array('s'=>'Qty','pdf'=>'true'),$_smarty_tpl);?>
</td>
...
;">
		<td style="text-align: left;">
			<?php if (!empty($_smarty_tpl->tpl_vars['order_detail']->value['product_id'])){?>
				<?php echo $_smarty_tpl->tpl_vars['order_detail']->value['product_id'];?>
...
?>
	<?php echo smarty_function_cycle(array('values'=>'#FFF,#DDD','assign'=>'bgcolor'),$_smarty_tpl);?>
		...
		<tr style="line-height:6px;background-color:<?php echo $_smarty_tpl->tpl_vars['bgcolor']->value;?>
; text-align:right;">
			<td colspan="<?php if (!$_smarty_tpl->tpl_vars['tax_excluded_display']->value){?>6<?php }else{ ?>5<?php }?>"><?php echo $_smarty_tpl->tpl_vars['cart_rule']->value['name'];?>
</td>
			<td>
